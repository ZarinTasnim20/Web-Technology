                     ...
                     <fieldset>
                         ...
                         <hr>
                          <fieldset>
                               ...
                               <input type="text" name = "email" id="email" onchange="showHint1(this.value);" class="form-control"onkeyup="checkEmail()" onblur="checkEmail()"/><span class="red">&nbsp;
                                <?php 
                                ...
                                </span><p id="emailErr"></p>
                          </fieldset>
                          <hr>
                         <fieldset>
                              <legend>User Name</legend>
                              <p> <span class="red" id="txtHint"></span></p>
                              <input type="text" name = "username" id="username" onchange="showHint(this.value);"class="form-control" onkeyup="checkUserName()" onblur="checkUserName()"/><span class="red">&nbsp;<?php if(isset($_SESSION["usernameErr"])){echo $_SESSION["usernameErr"]; $_SESSION["usernameErr"] = "";} ?></span><p id="usernameErr"></p>
